...
|
*/
$config['base_url'] = 'http://localhost/myhoaweb/';
...
$config['layout']['frontend']['javascripts'] = array('jquery-latest','jquery-ui','bootstrap','moment.min','jquery','bootstrap-material-datetimepicker','jAutoCalc','ninja-slider','common');
 
$config['layout']['frontend']['stylesheets'] = array('bootstrap.min', 'style','bootstrap-material-datetimepicker','https://fonts.googleapis.com/icon?family=Material+Icons','ninja-slider');
