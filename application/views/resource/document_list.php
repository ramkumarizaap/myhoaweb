<div class="container">
	...
	<div class="row pad-top-50 ">
		...
		<div class="col-md-8">
			<h2 class="margin-zero padd-zero"><?=ucwords($title);?></h2><br>
			<div class="col-md-12">
				<ul class="library-doc-one">
					<?php
					if($documents)
					{
						foreach ($documents as $key => $value) 
						{
							...
							?>
								<li>
									...
									<a href="<?=base_url()."resource/download/".$value['id'];?>" class="btn theme-blue white">Download</a>
								</li>
							<?php
						}
					}
